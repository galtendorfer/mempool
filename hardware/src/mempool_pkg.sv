...
package mempool_pkg;
  ...
  // DAS parameters
  // else 1 (not 0): NumDASPartitions=0 causes [unsigned(-1):0] in ctrl_registers.sv ports → VCS error
  localparam integer unsigned NumDASPartitions = `ifdef NUM_DAS_PARTITIONS `NUM_DAS_PARTITIONS `else 1 `endif;
