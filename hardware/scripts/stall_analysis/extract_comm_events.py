...
`traces/` and want to build a combined source/destination communication CSV.
...
def _parse_args(argv=None):
    ...
    parser.add_argument("result_dir", help="Benchmark result directory containing traces/ and data/")
